---
classes: wide
permalink: /hymns-for-the-poor-of-the-flock/301-400/301-310/O-happy-day!-when-first-we-felt/
title: |
    307 O happy day! when first we felt - Hymns for the Poor of the Flock
metadata:
    description: |
        Hymns for the Poor of the Flock 307. O happy day! when first we felt. O h a p p y day! when first we felt  Our souls with true contrition m e lt; And all our sins of crimson guilt  Were cleansed by blood on Calv’ry spilt. 
    keywords:  |
        Hymns for the Poor of the Flock, adventhymnals, advent hymnals, O happy day! when first we felt, O h a p p y day! when first we felt , 
