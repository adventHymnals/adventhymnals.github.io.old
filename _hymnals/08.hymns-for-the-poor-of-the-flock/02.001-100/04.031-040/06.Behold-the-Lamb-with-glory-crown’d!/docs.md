---
classes: wide
permalink: /hymns-for-the-poor-of-the-flock/001-100/031-040/Behold-the-Lamb-with-glory-crown’d!/
title: |
    036 Behold the Lamb with glory crown’d! - Hymns for the Poor of the Flock
metadata:
    description: |
        Hymns for the Poor of the Flock 036. Behold the Lamb with glory crown’d!. Behold the Lamb, with glory crown’d! To Him all pow’r is giv’n: No place too high for Him is found, No place too high in heav’n. 
    keywords:  |
        Hymns for the Poor of the Flock, adventhymnals, advent hymnals, Behold the Lamb with glory crown’d!, Behold the Lamb, with glory crown’d!, 
    author: Brian Onang'o
---

#### Advent Hymnals
## 036. Behold the Lamb with glory crown’d!
