---
classes: wide
permalink: /hymns-for-the-poor-of-the-flock/001-100/061-070/With-heav’n-in-view-we-tread-the-path/
title: |
    065 With heav’n in view we tread the path - Hymns for the Poor of the Flock
metadata:
    description: |
        Hymns for the Poor of the Flock 065. With heav’n in view we tread the path. With heav’n in view, we tread the path The saints of former ages trod; Like them, the children once of wrath,  But now, like Christ, the sons of God. 
    keywords:  |
        Hymns for the Poor of the Flock, adventhymnals, advent hymnals, With heav’n in view we tread the path, With heav’n in view, we tread the path, 
    author: Brian Onang'o
---

#### Advent Hymnals
## 065. With heav’n in view we tread the path
